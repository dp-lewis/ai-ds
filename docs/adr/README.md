...
| [0003](./0003-semantic-token-naming.md) | Semantic token names, and only colour tokens are theme-scoped | Accepted |
| [0004](./0004-storybook-as-showcase.md) | Storybook as the showcase, with autodocs and enforced a11y checks | Accepted |
...
| [0008](./0008-single-reference-component.md) | Scope the initial system to one reference component | Accepted |

All eight were taken on 2026-07-29, during the initial scaffold.
